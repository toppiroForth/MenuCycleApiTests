...
using System.Linq;
using MenuCycleApiTests_ci.Domain;
using Dapper;
using System.Data;
...
namespace MenuCycleApiTests_ci
{
    public class Helpers
    {
        ...
        public static string AbokadoConnectionString = ConfigurationManager.ConnectionStrings["StarChefAbokadoConnection"].ConnectionString;
        public static string MenuServiceConnectionStringQai = ConfigurationManager.ConnectionStrings["MenuServiceConnectionString"].ConnectionString;
        public static string MenuServiceConnectionStringCi = ConfigurationManager.ConnectionStrings["MenuServiceConnectionStringCi"].ConnectionString;

        public static int ExecuteStoredProc(string spName, params SqlParameter[] parameterValues)
        {
            using (var myConnection = new SqlConnection(AbokadoConnectionString))
            {
                myConnection.Open();
        ...
        public static int ExecuteStoredProc1(string spName, params SqlParameter[] parameterValues)
        {
            using (var myConnection = new SqlConnection(MenuServiceConnectionStringQai))
            {
                myConnection.Open();
        ...
        public static int ExecuteStoredProToDeleteMenucycle(string spName, params SqlParameter[] parameterValues)
        {

            using (var myConnection = new SqlConnection(MenuServiceConnectionStringCi))
            {
                myConnection.Open();
        ...
        //        IngredientType = o.ingredient_type,
        //        IsNonFoodItem = o.is_non_food_item,
        //        ProductClassificationId = o.product_classification_id,
